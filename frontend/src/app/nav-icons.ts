/** 사이드바 Icon Tree용 인라인 SVG path(24x24). 키 = nav 항목 id | 'overview' | 'fallback'.
...
export const NAV_ICON: Record<string, string> = {
  ...
  home: P.dashboard,
  // Foundation AI group
  'g-foundation': P.share,
  'llm-routes': P.share,
  'retrieval': P.input,
  // Agents group
  'g-agents': P.apps,
  'agents': P.cube,
  // Training & Models group
  'g-training': P.layers,
  'compute': P.server,
  'datasets': P.disk,
  'training-jobs': P.task,
  'model-promotion': P.rocket,
  // Eval & Inference group
  'g-eval': P.task,
  'eval-policy': P.shield,
  'eval-jobs': P.task,
  'inference': P.trending,
  // Ops group
  'g-ops': P.settings,
  'monitoring': P.gauge,
  'catalog': P.apps,
